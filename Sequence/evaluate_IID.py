...
parser.add_argument('--save_RC_dir', dest='save_RC_dir', default='./Results/IID/3_C/', help='directory for testing outputs')
parser.add_argument('--save_S_dir', dest='save_S_dir', default='./Results/IID/3_S/', help='directory for testing outputs')
parser.add_argument('--save_RT_dir', dest='save_RT_dir', default='./Results/IID/3_R/', help='directory for testing outputs')
parser.add_argument('--save_REC_dir', dest='save_REC_dir', default='./Results/IID/3_REC/', help='directory for testing outputs')
parser.add_argument('--test_dir', dest='test_dir', default='./dataset/test/demo/input_3/', help='directory for testing inputs')
