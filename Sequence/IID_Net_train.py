...
train_writer = tf.summary.FileWriter('./log' + '/IID',sess.graph,flush_secs=60)
#load data
###train_data
train_low_data = []
train_high_data = []
train_low_data_names = glob(args.train_data_dir +'/input_1/*') 
train_low_data_names.sort()
train_high_data_names = glob(args.train_data_dir +'/input_3/*') 
